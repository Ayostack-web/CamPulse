          ...
          <div className="cp-fade-up flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:gap-3 lg:items-end">
              ...
              <div className="flex items-center gap-2">
                {isAuthenticated && (
                  <button
                    onClick={() => setActiveLayer('chat')}
                    className="p-2.5 rounded-[1.25rem] border border-blue-100 bg-blue-50 text-gray-400 hover:text-blue-600 hover:bg-blue-100/70 shadow-sm transition-all active:scale-[0.98] sm:rounded-[1.5rem]"
